...
from DDSim.DD4hepSimulation import DD4hepSimulation # type: ignore
#from SystemOfUnits import mm, GeV, MeV, m, deg
from g4units import mm, GeV, MeV, m, deg # type: ignore
SIM = DD4hepSimulation()

## The compact XML file
SIM.compactFile = "/scratch/MCNozzleWork/geometries/MuColl_10TeV_v0A_Modded_Nozzle/MuColl_10TeV_blackhole_nozzle.xml"
...
SIM.inputFiles = ["/data/samples/mumu_H_bb_3TeV.hepmc"]
## Macro file to execute for runType 'run' or 'vis'
SIM.macroFile = ""
## number of events to simulate, used in batch mode. -1 all
SIM.numberOfEvents = 100
## Outputfile from the simulation,only lcio output is supported
SIM.outputFile = "mumu_H_bb_100E_BLACKHOLE_NOZZLE.slcio"
